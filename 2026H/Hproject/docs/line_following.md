...
1. Power up with the motor wheels lifted. The mode dispatcher remains in
   `CTRL_STOP` while it waits for the BLS single-click start decision.
   Double-click BLS within 350 ms to select the next question instead.
